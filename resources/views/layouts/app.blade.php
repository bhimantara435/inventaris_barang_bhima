...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ url('template/assets/compiled/css/iconly.css') }}">
    {{-- Datatables --}}
    <link rel="stylesheet"
...
<body>
    ...
    <script src="{{ url('template/assets/extensions/datatables.net/js/jquery.dataTables.min.js') }}"></script>
